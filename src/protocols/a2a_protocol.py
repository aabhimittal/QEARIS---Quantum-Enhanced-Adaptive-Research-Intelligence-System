...
class A2AProtocol:
    ...
    def register_agent(
        self, agent_id: str, handler: Callable, metadata: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
    ...
    async def _send_request(self, message: A2AMessage, timeout: float) -> A2AResponse:
        """
...
async def create_a2a_protocol(config: Optional[Dict[str, Any]] = None) -> A2AProtocol:
    """
