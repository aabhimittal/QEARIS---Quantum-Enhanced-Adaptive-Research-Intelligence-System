...
class QuantumCoordinatorAgent(BaseLLMAgent[Dict[str, Any]]):
    ...
    async def _process_task(self, coordination_task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # ================================================================
        assignments = self._build_assignment_mapping(
            best_assignment, tasks, agents
        )
        ...
        improvement_percent = (energy_reduction / abs(initial_energy)) * 100 if initial_energy != 0 else 0
